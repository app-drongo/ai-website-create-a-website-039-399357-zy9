...
export default function Hero({
  ...
  title = 'Build enterprise software',
  titleHighlight = '10x faster with Acme Tech',
  description = 'Revolutionary cloud-native development platform that empowers tech teams to ship production-ready applications with unprecedented speed and reliability.',
  features = [
  ...
  imageAlt = 'Acme Tech Development Dashboard',
